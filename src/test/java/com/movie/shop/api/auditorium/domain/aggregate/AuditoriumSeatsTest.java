...
class AuditoriumSeatsTest {
    ...
    void createSuccess() {
        ...
        Validation<Seq<String>, AuditoriumSeats> result = AuditoriumSeats.create(seats, 2, 3);

        assertTrue(result.isValid());
        AuditoriumSeats auditoriumSeats = result.get();
        assertEquals(seats, auditoriumSeats.getSeats());
        assertEquals(2, auditoriumSeats.getRowCount());
        assertEquals(3, auditoriumSeats.getColumnCount());
    }

    @Test
    @DisplayName("좌석 리스트가 비어 있으면 실패한다")
    void createFailWhenSeatsEmpty() {
        Validation<Seq<String>, AuditoriumSeats> result = AuditoriumSeats.create(List.of(), 2, 3);
    ...
    void createFailWhenSeatCountMismatch() {
        ...
        Validation<Seq<String>, AuditoriumSeats> result = AuditoriumSeats.create(seats, 2, 2);
    ...
    void createFailWhenRowCountTooSmall() {
        ...
        Validation<Seq<String>, AuditoriumSeats> result = AuditoriumSeats.create(seats, 0, 2);
    ...
    void createFailWhenRowCountTooLarge() {
        ...
        Validation<Seq<String>, AuditoriumSeats> result = AuditoriumSeats.create(seats, 101, 1);
    ...
    void createFailWhenColumnCountTooSmall() {
        ...
        Validation<Seq<String>, AuditoriumSeats> result = AuditoriumSeats.create(seats, 1, 0);
    ...
    void createFailWhenColumnCountTooLarge() {
        ...
        Validation<Seq<String>, AuditoriumSeats> result = AuditoriumSeats.create(seats, 1, 51);
