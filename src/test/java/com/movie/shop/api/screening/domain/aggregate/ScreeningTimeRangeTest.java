...
class ScreeningTimeRangeTest {
    ...
    void create_withEqualRuntime_succeeds() {
        ...
        Validation<Seq<String>, ScreeningTimeRange> validation = ScreeningTimeRange.create(start, runtimeEnd, movieCondition);
    ...
    void create_withInvalidRange_returnsRangeErrorFirst() {
        ...
        Validation<Seq<String>, ScreeningTimeRange> validation = ScreeningTimeRange.create(start, start, movieCondition);
