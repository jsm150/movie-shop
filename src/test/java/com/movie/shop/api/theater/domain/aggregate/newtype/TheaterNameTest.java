...
class TheaterNameTest {
    ...
    class CreateNewTest {
        ...
        void createNew_withValidName_success() {
            ...
            Validation<Seq<String>, TheaterName> result = TheaterName.createNew(validName, uniqueNameCondition);
        ...
        void createNew_withNullName_fail() {
            Validation<Seq<String>, TheaterName> result = TheaterName.createNew(null, uniqueNameCondition);
        ...
        void createNew_withEmptyName_fail() {
            Validation<Seq<String>, TheaterName> result = TheaterName.createNew("", uniqueNameCondition);
        ...
        void createNew_withTooLongName_fail() {
            ...
            Validation<Seq<String>, TheaterName> result = TheaterName.createNew(longName, uniqueNameCondition);
    ...
    class CreateFromTest {
        ...
        @BeforeEach
        void setUp() {
            existingName = TheaterName.createNew("기존영화관", uniqueNameCondition).get();
        }
        ...
        void createFrom_withDifferentValidName_success() {
            ...
            Validation<Seq<String>, TheaterName> result = TheaterName.createFrom(existingName, newName, uniqueNameCondition);
        ...
        void createFrom_withSameName_successWithoutDuplicateCheck() {
            ...
            Validation<Seq<String>, TheaterName> result = TheaterName.createFrom(existingName, sameName, duplicateNameCondition);
